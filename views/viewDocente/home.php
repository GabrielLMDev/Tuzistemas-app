...
if (!isset($_COOKIE['user'])) {
    ...
    $cookie_values = json_decode($cookie_value, true);
...
<body>
        ...
        <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
            <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4" id="sidebar">
                    ...
                    <a href="#" data-section="section3" class="list-group-item list-group-item-action py-2 ripple"><i class="fas fa-file fa-fw me-3"></i><span>Mostrar Archivos</span></a>
                    <a href="#" data-section="section4" class="list-group-item list-group-item-action py-2 ripple"><i class="fas fa-clock fa-fw me-3"></i><span>Subir Horario</span></a>
                    <a href="#" data-section="section5" class="list-group-item list-group-item-action py-2 ripple"><i class="fas fa-user fa-fw me-3"></i><span>Lista de Alumnos</span></a>
                </div>
            </div>
            <p class="text-bold p-4" style="position: absolute; bottom: 0;">Version 1.0 - View Teacher</p>
        </nav>
        <!-- Barra Lateral -->
        ...
        <nav id="main-navbar" class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
            ...
            <div class="container-fluid">
                ...
                <div id="sidebar">
                    ...
                    ?>
                    <a href="#" data-section="section6" class="btn btn-success position-relative">
                        Mensajes
                ...
                <ul class="navbar-nav ms-auto d-flex flex-row">
                    ...
                    <a data-mdb-dropdown-init class="nav-link hidden-arrow d-flex align-items-center" href="#" id="navbarDropdownMenuLink" role="button" data-mdb-toggle="dropdown" aria-expanded="false">
                        <img src="../../vendor/assets/icons/teacher.svg" class="rounded-circle" height="35" alt="Avatar" loading="lazy" />
                    </a>
                </ul>
            </div>
            <!-- Container wrapper -->
        ...
        <div class="container pt-4" id="content">
            ...
            <section id="section1" class="section container-fluid active-section">
                ...
                <div class="profile-container">
                    <img id="perfilImagen" class="profile-image" src="../../vendor/assets/icons/teacher.svg" alt="Avatar">
                    <div class="profile-username"><span style="font-size: 20px; color: #000;">Bienvenido, Profesor</span>
            ...
            <section id="section2" class="section container-fluid">
                ...
                $query = "SELECT gT_group FROM group_teacher WHERE gT_enrollment =" . $userEnrollment;
                ...
                <div class="upload-container">
                    ...
                    <form action="uploadFileFunction.php" method="POST" enctype="multipart/form-data" style="width: 26rem;">
                        <div data-mdb-input-init class="form-outline mb-4">
                            ...
                            <label class="form-label fw-bold text-white" for="enrollment">Matricula Docente</label>
                        </div>
                        <div data-mdb-input-init class="form-outline mb-4">
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                            <select class="form-select" aria-label="Default select example" name="groupFile">
                                <option selected>Seleccione grupo</option>
                                <?php
                                foreach ($groupT as $fila) {
                                ?>
                                    <option value="<?php echo $fila['gT_group']; ?>"><?php echo $fila['gT_group']; ?></option>
                                <?php
                                }
                                ?>
                            </select>
            ...
            <section id="section4" class="section container-fluid">
                <div class="upload-container">
                    <p class="h1 text-white pt-1 pb-3" style="text-align: center;">Enviar Horario al Grupo:</p>
                    <form action="uploadScheduleFunction.php" method="POST" enctype="multipart/form-data" style="width: 22rem;">
                        <div class="mb-4">
                            <label class="form-label fw-bold text-white" for="customFile">Elija el archivo:</label>
                            <input type="file" class="form-control" id="customFile" name="File" accept=".pdf" required />
                        </div>
                        <div data-mdb-input-init class="form-outline mb-4">
                            <select class="form-select" aria-label="Default select example" name="groupFile" required>
                                <option selected>Seleccione grupo</option>
                                <?php
                                foreach ($groupT as $fila) {
                                ?>
                        ...
                        <input type="submit" class="btn btn-success btn-lg mb-2" value="Enviar Horario">
                    </form>
                    <div class="table-container">
                        <p class="h1 text-white pt-4 pb-4" style="text-align: center;">Horarios Enviados:</p>
                        <table class="table align-middle mb-0 bg-transparent">
                            <thead class="bg-transparent text-white">
                                <tr>
                                    <th>Grupo</th>
                            ...
                            <tbody>
                                ...
                                // Consulta SQL para obtener los datos de la tabla
                                $query = "SELECT * FROM schedule WHERE S_Autor =" . $cookie_values['enrollment'];
                                $resultado = $conexion->query($query);
                                if ($resultado) {
                                    // Inicializar un array para almacenar los datos
                                    $datos = array();
                                ...
                                foreach ($datos as $fila) { ?>
                                    <tr>
                                        <td>
                                            <p class="fw-normal text-white mb-1"><?php echo $fila['S_Group']; ?></p>
                                        </td>
                                        <td>
                                            <p class="fw-normal text-white mb-1"><?php echo $fila['S_Name']; ?></p>
                                        </td>
                                        <td>
                                            <a href="deleteScheduleFunction.php?id=<?php echo $fila['S_Id']; ?>" class="py-2 ripple text-white"><i class="fas fa-circle-xmark fa-fw me-3"></i></a>
                                        </td>
                                        <td class="text-white"><?php echo $fila['S_Date']; ?></td>
                                    </tr>
                                <?php }
                                ?>
                            </tbody>
            ...
            <section id="section5" class="section container-fluid">
                <div class="upload-container">
                    <p class="h1 text-white pt-1 pb-3" style="text-align: center;">Alumnos</p>
                    <form id="search_group_form" style="width: 22rem;">
                        <div data-mdb-input-init class="form-outline mb-4">
                            <select class="form-select" aria-label="Default select example" id="groupSelect" name="groupSelect" required>
                                <option selected>Seleccione grupo</option>
                                <?php
                                foreach ($groupT as $fila) {
                                ?>
                    ...
                    <table id="usuariosTable" class="hidden table align-middle mb-0 bg-transparent">
                        <thead class="bg-transparent text-white">
                            <tr>
                                <th>Nombre</th>
    ...
    <script src="../../vendor/js/groupListFunction.js?_v=<?php echo rand(1, 15) ?>"></script>
</body>
